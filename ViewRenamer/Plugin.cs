...
namespace Carfup.XTBPlugins.ViewRenamer
{
    ...
    [Export(typeof(IXrmToolBoxPlugin)),
        ExportMetadata("Name", "View Renamer"),
        ExportMetadata("Description", "If you want to rename your views in several languages in few clicks, this is the tool you are looking for !"),
